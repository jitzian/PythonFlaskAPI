...
class Products(Resource):
	def get(self):
		#Connect to databse
		conn = e.connect()
		strQry = "SELECT distinct PROD.PRO_NAME, PROD.PRO_DESCRIPTION, STORE.STO_NAME, CATEGORY.CAT_NAME, LANE.LAN_NAME, LANE.LAN_NUM_NAME from TB_STORE AS STORE, TB_PRODUCT AS PROD, TB_LANE AS LANE, TB_CATEGORY AS CATEGORY WHERE PROD.PK_TB_PRODUCT = CATEGORY.FK_TB_PRODUCT AND LANE.PK_TB_LANE = PROD.FK_TB_LANE"
